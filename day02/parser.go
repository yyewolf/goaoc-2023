...
var input = []byte(`Game 1: 7 blue, 9 red, 1 green; 8 green; 10 green, 5 blue, 3 red; 11 blue, 5 red, 1 green
...
var inputTest = []byte(`Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
